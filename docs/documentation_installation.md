...
| PREVARISC_PLATAU_NO_HEALTHCHECK               | [FACULTATIF] Permet de désactiver le healthchek Plat'AU sur la page d'accueil                                                                                                  | 0 ou 1 pour désactiver (healthcheck activé par défaut)                                                     |
