...
class Service_Search
{
    ...
    private function addJoins(Zend_Db_Select $select, bool $environnement): void
    {
        if ($environnement) {
            $select->joinLeft(
                'etablissementadresseapi',
                'e.ID_ETABLISSEMENT = etablissementadresseapi.ID_ETABLISSEMENT',
                ['NUMINSEE_COMMUNE', 'LON_ETABLISSEMENTADRESSE', 'LAT_ETABLISSEMENTADRESSE', 'ID_ADRESSE', 'LIBELLE_RUE', 'ADRESSE', 'LIBELLE_COMMUNE']
            )
            ...
            $select->joinLeft(
                ...
                'e.ID_ETABLISSEMENT = etablissementadresse.ID_ETABLISSEMENT',
                ['NUMINSEE_COMMUNE', 'LON_ETABLISSEMENTADRESSE', 'LAT_ETABLISSEMENTADRESSE', 'ID_ADRESSE', 'ID_RUE', 'NUMERO_ADRESSE', 'COMPLEMENT_ADRESSE']
            )
                ->joinLeft(
                    'adressecommune',
                    'etablissementadresse.NUMINSEE_COMMUNE = adressecommune.NUMINSEE_COMMUNE',
                    'LIBELLE_COMMUNE AS LIBELLE_COMMUNE_ADRESSE_DEFAULT'
                )
                ->joinLeft(
                    'groupementcommune',
                    'groupementcommune.NUMINSEE_COMMUNE = adressecommune.NUMINSEE_COMMUNE'
                )
                ->joinLeft(
                    'adresserue',
                    'adresserue.ID_RUE = etablissementadresse.ID_RUE',
                    'LIBELLE_RUE'
                )
                ->joinLeft(
                ...
                ->joinLeft(
                    ['adressecommunesite' => 'adressecommune'],
                    'etablissementadressesite.NUMINSEE_COMMUNE = adressecommunesite.NUMINSEE_COMMUNE',
                    'LIBELLE_COMMUNE AS LIBELLE_COMMUNE_ADRESSE_SITE'
                )
                ->joinLeft(
                    ['etablissementadressecell' => 'etablissementadresse'],
                    'etablissementadressecell.ID_ETABLISSEMENT = (SELECT ID_ETABLISSEMENT FROM etablissementlie WHERE ID_FILS_ETABLISSEMENT = e.ID_ETABLISSEMENT LIMIT 1)',
                    'ID_RUE AS ID_RUE_CELL'
                )
                ->joinLeft(
                    ['adressecommunecell' => 'adressecommune'],
                    'etablissementadressecell.NUMINSEE_COMMUNE = adressecommunecell.NUMINSEE_COMMUNE',
                    'LIBELLE_COMMUNE AS LIBELLE_COMMUNE_ADRESSE_CELLULE'
                )
            ;
        }
    ...
    private function addCriteriaWithApi(Zend_Db_Select $select, ?string $type, $adresse, $genres): void
    {
