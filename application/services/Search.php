    ...
    public function dossiers($types = null, $objet = null, $num_doc_urba = null, $parent = null, $avis_differe = null, $count = 10, $page = 1, $criterias = null)
    {
        ...
        if (($results = unserialize($cache->load($search_id))) === false) {
            ...
            $select->from(['d' => 'dossier'])
                ...
                ->joinLeft(['eia' => 'etablissementinformationsactuel'], 'e.ID_ETABLISSEMENT = eia.ID_ETABLISSEMENT', ['LIBELLE_ETABLISSEMENTINFORMATIONS', 'ID_ETABLISSEMENT'])
                ->joinLeft('type', 'type.ID_TYPE = eia.ID_TYPE', ['ID_TYPE', 'LIBELLE_TYPE'])
                ->joinLeft('genre', 'genre.ID_GENRE = eia.ID_GENRE', 'LIBELLE_GENRE')
