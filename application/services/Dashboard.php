...
class Service_Dashboard
{
    ...
    public function __construct($options = [])
    {
        ...
        if (false !== getenv('PREVARISC_DASHBOARD_NEXT_COMMISSIONS_DAYS', true) ? getenv('PREVARISC_DASHBOARD_NEXT_COMMISSIONS_DAYS', true) : getenv('PREVARISC_DASHBOARD_NEXT_COMMISSIONS_DAYS')) {
            $this->options['next_commissions_days'] = (int) (false !== getenv('PREVARISC_DASHBOARD_NEXT_COMMISSIONS_DAYS', true) ? getenv('PREVARISC_DASHBOARD_NEXT_COMMISSIONS_DAYS', true) : getenv('PREVARISC_DASHBOARD_NEXT_COMMISSIONS_DAYS'));
        }

        if (false !== getenv('PREVARISC_DASHBOARD_DOSSIERS_SANS_AVIS_DAYS', true) ? getenv('PREVARISC_DASHBOARD_DOSSIERS_SANS_AVIS_DAYS', true) : getenv('PREVARISC_DASHBOARD_DOSSIERS_SANS_AVIS_DAYS')) {
            $this->options['dossiers_sans_avis_days'] = (int) (false !== getenv('PREVARISC_DASHBOARD_DOSSIERS_SANS_AVIS_DAYS', true) ? getenv('PREVARISC_DASHBOARD_DOSSIERS_SANS_AVIS_DAYS', true) : getenv('PREVARISC_DASHBOARD_DOSSIERS_SANS_AVIS_DAYS'));
        }

        if (false !== getenv('PREVARISC_DASHBOARD_COURRIER_SANS_REPONSE_DAYS', true) ? getenv('PREVARISC_DASHBOARD_COURRIER_SANS_REPONSE_DAYS', true) : getenv('PREVARISC_DASHBOARD_COURRIER_SANS_REPONSE_DAYS')) {
            $this->options['courrier_sans_reponse_days'] = (int) (false !== getenv('PREVARISC_DASHBOARD_COURRIER_SANS_REPONSE_DAYS', true) ? getenv('PREVARISC_DASHBOARD_COURRIER_SANS_REPONSE_DAYS', true) : getenv('PREVARISC_DASHBOARD_COURRIER_SANS_REPONSE_DAYS'));
        }
        ...
        if (!filter_var(false !== getenv('PREVARISC_DEACTIVATE_PLATAU', true) ? getenv('PREVARISC_DEACTIVATE_PLATAU', true) : getenv('PREVARISC_DEACTIVATE_PLATAU'), FILTER_VALIDATE_BOOLEAN)) {
            ...
            $this->blocsConfig['pjPlatauErreur'] = [
                'service' => Service_Dashboard::class,
                'method' => 'getDossiersPlatauPjsEnErreur',
                'acl' => ['dashboard', 'view_doss_platau_pjs_en_erreur'],
                'title' => "Dossiers Plat'AU avec des pièces jointes non envoyées",
                'type' => 'dossiers',
                'height' => 'small',
                'width' => 'small',
            ];
