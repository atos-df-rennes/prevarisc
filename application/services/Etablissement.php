...
class Service_Etablissement implements Service_Interface_Etablissement
{
    ...
    public function getDefaultValues($genre, $numinsee = null, $type = null, $categorie = null, $local_sommeil = null, $classe = null, $id_etablissement_pere = null, $ids_etablissements_enfants = null): array
    {
        ...
        switch ($genre) {
            ...
            case 2:
                ...
                if (null !== $type) {
                    if (getenv('PREVARISC_LOCAL_SOMMEIL_TYPES', true) !== false ? getenv('PREVARISC_LOCAL_SOMMEIL_TYPES', true) : getenv('PREVARISC_LOCAL_SOMMEIL_TYPES')) {
                        $concerned_types = explode(';', getenv('PREVARISC_LOCAL_SOMMEIL_TYPES', true) !== false ? getenv('PREVARISC_LOCAL_SOMMEIL_TYPES', true) : getenv('PREVARISC_LOCAL_SOMMEIL_TYPES'));
                    } else {
    ...
    public function getDisplayedPeriodicity(array $etablissement): string
    {
        ...
        if (
            !filter_var(getenv('PREVARISC_UNITE_PERIODICITE_ANNEES', true) !== false ? getenv('PREVARISC_UNITE_PERIODICITE_ANNEES', true) : getenv('PREVARISC_UNITE_PERIODICITE_ANNEES'), FILTER_VALIDATE_BOOLEAN)
        ) {
