...
class Form_Login extends Zend_Form
{
    public function init(): void
    {
        ...
        $this->addElement('text', 'prevarisc_login_username', [
            ...
            'autocomplete' => getenv('PREVARISC_ENFORCE_SECURITY', true) ?: getenv('PREVARISC_ENFORCE_SECURITY') ? 'off' : 'on',
        ]);
        ...
        if (1 == getenv('PREVARISC_ENFORCE_SECURITY', true) ?: getenv('PREVARISC_ENFORCE_SECURITY')) {
