...
class Api_Service_Search
{
     ...
     * @return array
     */
    public function etablissements($label = null, $identifiant = null, $genres = null, $categories = null, $classes = null, $familles = null, $types_activites = null, $avis_favorable = null, $statuts = null, $local_sommeil = null, $periodicite = null, $lon = null, $lat = null, $parent = null, $commissions = null, $groupements_territoriaux = null, $count = 10, $page = 1)
    {
        $service_search = new Service_Search();

        return $service_search->etablissements($label, $identifiant, $genres, $categories, $classes, $familles, $types_activites, $avis_favorable, $statuts, $local_sommeil, $periodicite, $lon, $lat, $parent, null, null, null, $commissions, $groupements_territoriaux, $count, $page);
    }
