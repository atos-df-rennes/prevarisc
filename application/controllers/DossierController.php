...
class DossierController extends Zend_Controller_Action
{
    ...
    public function creationdocAction($idDossier, $idEtab, $commission): void
    {
        ...
        $this->view->assign('isDescriptifPersonnalise', 1 === (int) (getenv('PREVARISC_DESCRIPTIF_PERSONNALISE', true) !== false ? getenv('PREVARISC_DESCRIPTIF_PERSONNALISE', true) : getenv('PREVARISC_DESCRIPTIF_PERSONNALISE')));
