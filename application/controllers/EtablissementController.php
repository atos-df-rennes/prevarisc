...
class EtablissementController extends Zend_Controller_Action
{
    ...
    public function descriptifAction(): void
    {
        ...
        if (1 === (int) (getenv('PREVARISC_DESCRIPTIF_PERSONNALISE', true) !== false ? getenv('PREVARISC_DESCRIPTIF_PERSONNALISE', true) : getenv('PREVARISC_DESCRIPTIF_PERSONNALISE')) && false === $displayOriginal) {
    ...
    public function editDescriptifAction(): void
    {
        ...
        if (1 === (int) (getenv('PREVARISC_DESCRIPTIF_PERSONNALISE', true) !== false ? getenv('PREVARISC_DESCRIPTIF_PERSONNALISE', true) : getenv('PREVARISC_DESCRIPTIF_PERSONNALISE'))) {
