...
class EtablissementController extends Zend_Controller_Action
{
    ...
    public function indexAction(): void
    {
        ...
        $this->view->assign('key_ign', false !== getenv('PREVARISC_PLUGIN_IGNKEY', true) ? getenv('PREVARISC_PLUGIN_IGNKEY', true) : getenv('PREVARISC_PLUGIN_IGNKEY'));
    ...
    public function descriptifAction(): void
    {
        ...
        if (1 === (int) (false !== getenv('PREVARISC_DESCRIPTIF_PERSONNALISE', true) ? getenv('PREVARISC_DESCRIPTIF_PERSONNALISE', true) : getenv('PREVARISC_DESCRIPTIF_PERSONNALISE')) && false === $displayOriginal) {
    ...
    public function editDescriptifAction(): void
    {
        ...
        if (1 === (int) (false !== getenv('PREVARISC_DESCRIPTIF_PERSONNALISE', true) ? getenv('PREVARISC_DESCRIPTIF_PERSONNALISE', true) : getenv('PREVARISC_DESCRIPTIF_PERSONNALISE'))) {
    ...
    public function editTextesApplicablesAction(): void
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $this->redirect('/etablissement/'.$id.'/textes-applicables');
        }
    }
